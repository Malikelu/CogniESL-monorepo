...
class GenerateImage(BaseTool):
    ...
    Supports two modes:
    - Complex Diagrams (Flowcharts, Pyramids, Org Charts): Uses gemini-2.5-flash optimized for text rendering
    - Concept Art (Illustrations, Atmosphere): Uses gemini-2.5-flash for faster generation
    ...
    image_type: Literal["diagram", "concept_art"] = Field(
        ...,
        description="Type of image: 'diagram' for flowcharts/org charts (uses gemini-2.5-flash), 'concept_art' for illustrations"
    )
